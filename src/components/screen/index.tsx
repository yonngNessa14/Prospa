import { PADDING_HORIZONTAL, PADDING_TOP } from '@helpers/consts';
    ...
    return (
      <ScrollView
        style={[
          styles.container,
          style,
          paddingHorizontal && { paddingHorizontal: RW(PADDING_HORIZONTAL) },
          paddingTop && { paddingTop: RH(PADDING_TOP) },
        ]}
...
export const ScrollArea = ({
  ...
  <ScrollView
    ...
    contentContainerStyle={[{ flexGrow: flexGrow }]}
